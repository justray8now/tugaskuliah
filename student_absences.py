class UNY:                                                          #RAHMAT AGENG YUWANA
    def __init__(self, nama, no_abs):                               #20537144005
        self.nama = str(nama)
...
print("===================================================================")
print("             Selamat Datang Di Aplikasi Absensi     ")
print("===================================================================")
print("                                     Menu              ")
print("1. Tambah Data       ")
print("2. Hapus Data        ")
...
print("7. Jumlah Total Siswa yang Sudah Absen")
print("0. Keluar            ")
print("======================================================================")
